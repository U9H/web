...
The Elm compiler gives users a hint on how to fix their code at the bottom.  Don't worry if you don't understand this completely.  Just pay attention to the hint on the bottom, and recognize how it guides the user.
